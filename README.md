...
관리자 페이지는 다음과 같은 11개 컬럼 구조를 사용합니다:

| 카드ID | 카드명 | 발급사 | 연회비타입 | 연회비브랜드 | 연회비 | 카테고리 | 혜택타입 | 할인율 | 월최대한도 | 설명 |
|--------|--------|--------|-----------|-------------|--------|----------|----------|--------|------------|------|
| card1  | KB국민 My WE:SH | KB국민카드 | 국내전용 | VISA | 15000 | 식비 | discount | 10 | 10000 | 음식점 10% 할인 |
| card1  | KB국민 My WE:SH | KB국민카드 | 해외겸용 | VISA | 18000 | 식비 | discount | 10 | 10000 | 음식점 10% 할인 |
| card1  | KB국민 My WE:SH | KB국민카드 | 해외겸용 | Mastercard | 18000 | 카페 | discount | 20 | 6000 | 스타벅스 20% 할인 |
