...
document.getElementById('infoForm').addEventListener('submit', async (e) => {
  ...
  // ↳ 필드명이 kor_name, kor_dept, kor_title, phone, email_id, eng_name, eng_dept, eng_title 인지 반드시 확인
  ...
  console.log('PDF 페이지 수:', pages.length);
